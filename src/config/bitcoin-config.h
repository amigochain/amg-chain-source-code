...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Amigo Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Amigo Core"
...
#define PACKAGE_BUGREPORT "https://github.com/amigo/amigo-core/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Amigo Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Amigo Core 0.16.0.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "amigo"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://amigo.io/"

/* Define to the version of this package. */
#define PACKAGE_VERSION "0.16.0.3"
