...
public:
    ...
    virtual bool IsAmigoVersion() const { return false; }
...
public:
    ...
    bool IsAmigoVersion() const { return txTo && txTo->IsAmigoVersion(); }
...
public:
    bool IsAmigoVersion() const { return tx.IsAmigoVersion(); }
...
class DummySignatureCreatorAmigo : public DummySignatureCreator {
public:
    DummySignatureCreatorAmigo(const CKeyStore* keystoreIn) : DummySignatureCreator(keystoreIn) {}
