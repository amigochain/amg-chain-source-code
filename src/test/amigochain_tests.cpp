...
BOOST_FIXTURE_TEST_SUITE(amigochain_tests, BasicTestingSetup)
...
BOOST_AUTO_TEST_CASE(signature_test)
{
    ...
    txn2.nVersion = AMIGO_TXN_VERSION;
...
BOOST_AUTO_TEST_CASE(amigochain_test)
{
    SeedInsecureRand();
    CBasicKeyStore keystore;
    ...
    CBlock blk;
    blk.nVersion = AMIGO_BLOCK_VERSION;
    blk.nTime = 1487406900;
    ...
    txnSpend.nVersion = AMIGO_BLOCK_VERSION;
}
